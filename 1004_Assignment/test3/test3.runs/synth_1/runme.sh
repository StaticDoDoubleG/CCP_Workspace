...
HD_PWD='C:/Users/nveloper/GitHub/CCP_Workspace/1004_Assignment/test3/test3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log or_4bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source or_4bits.tcl
