...
HD_PWD='C:/Users/nveloper/GitHub/CCP_Workspace/1004_Assignment/test3/test3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log or_4bits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source or_4bits.tcl -notrace
