...
HD_PWD='C:/Users/nveloper/GitHub/CCP_Workspace/1004_Assignment/test2/test2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log or_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source or_2.tcl -notrace
