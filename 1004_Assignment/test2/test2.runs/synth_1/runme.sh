...
HD_PWD='C:/Users/nveloper/GitHub/CCP_Workspace/1004_Assignment/test2/test2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log or_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source or_2.tcl
