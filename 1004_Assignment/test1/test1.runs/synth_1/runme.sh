...
HD_PWD='C:/Users/nveloper/GitHub/CCP_Workspace/1004_Assignment/test1/test1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log and_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source and_2.tcl
