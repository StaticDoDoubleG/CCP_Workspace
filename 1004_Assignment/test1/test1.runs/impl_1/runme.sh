...
HD_PWD='C:/Users/nveloper/GitHub/CCP_Workspace/1004_Assignment/test1/test1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log and_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source and_2.tcl -notrace
