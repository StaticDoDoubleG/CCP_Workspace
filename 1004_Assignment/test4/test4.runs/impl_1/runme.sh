...
HD_PWD='C:/Users/nveloper/GitHub/CCP_Workspace/1004_Assignment/test4/test4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log andor_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source andor_2.tcl -notrace
