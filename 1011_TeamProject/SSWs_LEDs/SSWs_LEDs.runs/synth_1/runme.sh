...
HD_PWD='C:/Users/1214/32w604e/SSWs_LEDs/SSWs_LEDs.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SSWs_LEDs.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SSWs_LEDs.tcl
