...
HD_PWD='C:/Users/1214/32w604e/SSWs_LEDs/SSWs_LEDs.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SSWs_LEDs.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SSWs_LEDs.tcl -notrace
